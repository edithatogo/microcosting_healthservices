/*
		+-------------------------------------------------------------------+
		| File:			NWAU24_CALCULATOR_OUTPATIENTS.sas					|
		| Name:			2024-25 Non-Admitted Patients						|
		|				National Weighted Activity Unit Calculator			|
		| Version:		1.0													|
		| Author:		Jada Ching											|
		| Modified: 	Pricing Section										|
		|				Independent Health and Aged Care Pricing Authority	|
		| Description:	The Non-admitted NWAU24 calculator. This file is 	|
...
data _OP_PRICE_WEIGHTS ( index = ( &tier2_clinic. ) ) ;
	...
	set CALCREF.NEP24_OP_PRICE_WEIGHTS
...
data _null_ ;
	...
	set CALCREF.NEP24_op_multi_prov_adj ;
...
data _nep24_hospital_ra2021 ( index = ( APCID&ID_YEAR. ) ) ;
...
/*	GET HOSPITAL REMOTENESS VALUE */
	...
	%if &EST_REMOTENESS_OPTION. = 1 %then %do ;
		...
		set _nep24_hospital_ra2021 ( keep = apcid&ID_YEAR. _hosp_ra_2021 ) key = apcid&ID_YEAR. /unique ;
