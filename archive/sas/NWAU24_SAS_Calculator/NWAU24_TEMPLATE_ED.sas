/*
		+---------------------------------------------------------------------------+
		| Name:			NWAU24_TEMPLATE_ED.sas										|
		| Description:	2024-25 Emergency Department Patients						|
...
%let ESTID = estabid ;									/* 699156 */			/* Character */
...
%include "&LOCATION.\NWAU24_CALCULATOR_ED.sas" ;