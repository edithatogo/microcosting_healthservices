/************************************************
 ...
 Description : A template file for running the Admitted Subacute NWAU22 calculator. To run the calculator fill in the RHS of the macro variable
...
%let PAT_RADIOTHERAPY_FLAG = radio_flag ;
...
%let PAT_DIALYSIS_FLAG = dialysis_flag ;
...
%let EST_REMOTENESS = _treat_remoteness ;				/* 697105 */			/* Integer 0-4 */
...
/*=====================================================================*/
/*Stage 7: Select shadow weight option and AN-SNAP Classification */
/*=====================================================================*/

/* Default is SHADOW = 0 to calculate SNAP v4.01 price. 

	SNAP v5 is being shadow priced in NEP22. Choose 1 to shadow price SNAP v5*/

%let SHADOW = 0 ;

/* AN-SNAP Classification variable */

%let ANSNAP = snapClassV401 ;						/* Character - length 4, beginning with '4' e.g. 4AZ1  if AN-SNAPv4.01 is used or beginning with '5' e.g. 5AZ1  if AN-SNAPv5 is used */
...
%let PAT_SA2 = sa2 ;								/* 659725 */			/* Integer length 9 */
...
%let BIRTH_DATE = birth_date ;						/* 287007 */			/* Date DDMMYYY*/
...
%let LEAVE = leaveDays ;							/* 270251 */			/* Integer >= 0 */
...
%let FUNDSC = fundSc ;								/* 679815 */			/* Integer 1-13 , 88, 98 */
...
%include "&LOCATION.\NWAU22_CALCULATOR_SUBACUTE.sas" ;