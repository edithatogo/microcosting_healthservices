/************************************************
 ...
 Description : A template file for running the Emergency Department NWAU22 calculator. To run the calculator fill in the RHS of the macro variable
...
/* This variable is used to match the hospital identifier you provide with an APCID from the hospital list. If you want to use a previous year's 
	APCID then list that year below. For NEP22 the default is 1920. */
...
%include "&LOCATION.\NWAU22_CALCULATOR_ED.sas" ;