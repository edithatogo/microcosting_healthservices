...
def model_vars(n, risk_factors_df):
    ...
    common_risk_factors = ['an100mdc_ra', 'agegroup_rm','flag_emergency',
...
if __name__ == '__main__':
    ...
    data['drg10_type_m'] = (data['drg10_type'] == 'M').astype(np.int8)
    data.an100mdc_ra = data.an100mdc_ra.replace('.','99')
