/*
		+---------------------------------------------------------------------------+
		| Name:			NWAU25_TEMPLATE_OUTPATIENTS.sas								|
		| Description:	2025-26 Non-admitted Patients								|
...
- Option 2: Aggregate level dataset - functionality for aggregate datasets will be removed in future editions */
...
/* &ID_YEAR. determines the financial year for which you want to match the above APCID when determining establishment paediatric eligibility and
	...
	1516 financial year then set ID_YEAR = 1516. By	default this is 2223, the year of the data used to calculate NEP25. */
...
%let Pat_SA2 = SA2 ;									/* 747315 */			/* Integer 123456789 */
...
%include "&LOCATION.\NWAU25_CALCULATOR_OUTPATIENTS.sas" ;