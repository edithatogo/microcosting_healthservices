/*
		+---------------------------------------------------------------------------+
		| Name:			NWAU23_TEMPLATE_MH.sas										|
		| Description:	2023-24 Admitted and Community Mental Health Patients		|
...
/* Admitted Mental Health Care Classification is used to price Admitted mental health from NEP22. 
	Community mental health is still shadow priced as of NEP23
...
%include "&LOCATION.\NWAU23_CALCULATOR_MH.sas" ;