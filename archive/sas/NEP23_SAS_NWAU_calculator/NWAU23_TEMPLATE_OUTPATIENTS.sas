/*
		...
		| Description:	2023-24 Non-admitted Patients								|
...
/* &ID_YEAR. determines the financial year for which you want to match the above APCID when determining establishment paediatric eligibility and
	...
	1516 financial year then set ID_YEAR = 1516. By	default this is 2021, the year of the data used to calculate NEP23. */
...
%include "&LOCATION.\NWAU23_CALCULATOR_OUTPATIENTS.sas" ;