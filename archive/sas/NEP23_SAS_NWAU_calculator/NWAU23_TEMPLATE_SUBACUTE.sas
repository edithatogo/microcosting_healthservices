/*
		+---------------------------------------------------------------------------+
		| Name:			NWAU23_TEMPLATE_SUBACUTE.sas								|
		| Description:	2023-24 Admitted Subacute Patients							|
...
/* Default is SHADOW = 0 to calculate SNAP v4.02 price. 
...
%let ANSNAP = snapClassV402 ;						/* Character - length 4, beginning with '4' e.g. 4AZ1  if AN-SNAPv4.02 is used or beginning with '5' e.g. 5AZ1  if AN-SNAPv5 is used */
...
%include "&LOCATION.\NWAU23_CALCULATOR_SUBACUTE.sas" ;