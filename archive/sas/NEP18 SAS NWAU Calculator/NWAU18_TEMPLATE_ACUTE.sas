...
/*
		+---------------------------------------------------------------------------+
		| Name:			Risk Ajusted NWAU18 Calculator TEMPLATE.sas					|
...
%let LOCATION = C:\Calculator\Risk Adjusted NWAU18 Calculator;
...
%let DRG=DRG9;
%let ICD10AM_Edition=9;						/*7,8,9 or 10*/
...
%let PSYCDAYS = psychdays;								/*552375*/				/*Integer*/
...
%include "&location.\NWAU18_ADJUSTED_CALCULATOR_ACUTE.sas"; 
