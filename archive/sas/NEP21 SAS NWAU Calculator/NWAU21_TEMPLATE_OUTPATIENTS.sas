/************************************************
 ...
 Description : A template file for running the Non-admitted NWAU21 calculator. To run the calculator fill in the RHS of the macro variable
...
/* The following two variables pertain only to aggregate datasets. They must be included if and only if you choose &DATA_TYPE. = 2 above.  */
...
%let TIER2_CLINIC = T2Clinic ;							/* 733027 */			/* Numeric NN.NN */
...
/* &ID_YEAR. determines the financial year for which you want to match the above APCID when determining establishment paediatric eligibility and
	...
	1516 financial year then set ID_YEAR = 1516. By	default this is 1819, the year of the data used to calculate NEP21. */
...
/*=====================================================================*/
/*Stage 7: Include SAS code that runs the calculator */
/*=====================================================================*/
...
%include "&LOCATION.\NWAU21_CALCULATOR_OUTPATIENTS.sas" ;