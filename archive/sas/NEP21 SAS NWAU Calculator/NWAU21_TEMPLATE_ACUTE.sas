/*
		+---------------------------------------------------------------------------+
		| Name:			Risk Ajusted NWAU21 Calculator TEMPLATE.sas					|
...
%let PROC_PREFIX = x10srg ; /* ie. variables are x10srg01 to x10srg50 */

%let DIAG_PREFIX = x10ddx ; /* ie. variables are x10ddx01 to x10ddx100 */
...
%let ICD10AM_Edition = 10 ;					/*07, 08, 09 or 10*/
...
/* Private Patient Service Adjustment Options. Choose 1 for 'nation-level' or 2 for 'juristiction-level'. Option 2 is that being used in NEP21. */

%let PPSERVADJ = 2 ;

/*=====================================================================*/
/*Stage 6: Choose shadow weight option*/
/*=====================================================================*/
/*if using shadow mental health weights use option 1, if no shadow weights use 0*/
...
%let ADM_PREV_YEAR_INPUT = file ; /* Requred for PAST_ADMISSIONS_OPTION = 2 */
...
%include "&location.\NWAU21_ADJUSTED_CALCULATOR_ACUTE.sas"; 