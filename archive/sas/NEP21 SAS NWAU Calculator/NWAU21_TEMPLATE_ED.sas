/************************************************
 ...
 Description : A template file for running the Emergency Department NWAU21 calculator. To run the calculator fill in the RHS of the macro variable
...
%let CLASSIFICATION_OPTION = 3 ;
	...
	*/
	...
	%let AECC = AECC11 ;															/* Character - length 5: ENNNC */
...
/* This variable is used to match the hospital identifier you provide with an APCID from the hospital list. If you want to use a previous year's 
	APCID then list that year below. For NEP21 the default is 1819. */
...
%include "&LOCATION.\NWAU21_CALCULATOR_ED.sas" ;