/************************************************
 ...
 Description : A template file for running the Admitted Subacute NWAU21 calculator. To run the calculator fill in the RHS of the macro variable
...
%let PAT_SA2 = ASGS ;								/* 659725 */			/* Integer length 9 */
...
%let ANSNAP_V4 = snapClassV4 ;												/* Character - length 4, beginning with '4' e.g. 4AZ1 */
...
%let INDSTAT = indStat ;							/* 723676 */			/* Integer 1-4, 9 */
...
%include "&LOCATION.\NWAU21_CALCULATOR_SUBACUTE.sas" ;