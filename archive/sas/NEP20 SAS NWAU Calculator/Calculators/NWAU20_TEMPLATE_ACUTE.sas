...
/*
		+---------------------------------------------------------------------------+
		| Name:			Risk Ajusted NWAU20 Calculator TEMPLATE.sas					|
...
%let LOCATION = C:\Calculator\Risk Adjusted NWAU20 Calculator;
...
%let DRG = DRG10;
%let ICD10AM_Edition = 10;					/*7, 8, 9 or 10*/
...
%include "&location.\NWAU20_ADJUSTED_CALCULATOR_ACUTE.sas"; 
