/*
		+---------------------------------------------------------------+
		| Name:			NWAU16_TEMPLATE_OUTPATIENTS.sas					|
...
%let FUNDSC = fundsc2		;							/*553314*/				/*Integer 1-13,99*/
...
%let TIER2_CLINIC = t2cLINIC1;							/*501669*/				/*Numeric NN.NN*/
...
/*=====================================================================*/
%include "&LOCATION.\NWAU16_CALCULATOR_OUTPATIENTS.sas";