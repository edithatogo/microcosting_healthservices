...
The bundle describes a versioned binding contract for calculator request and response models, a primary Arrow/Parquet file surface, service fallback path, diagnostics, stable errors, fixture gates, and Gradle/Maven readiness.
...
- `java-jvm-binding.schema.json`: JSON Schema for the binding contract bundle.
- `java-jvm-binding.contract.json`: Versioned synthetic contract document.
...
- Keep Kotlin and Java models compatible with Maven and Gradle consumers without committing platform-specific build outputs.
