...
- [x] Task: Compare C ABI, service, and Arrow/Parquet file interop for native Kotlin users.
    - [x] Select an initial strategy that minimizes binary packaging risk.
    - [x] Define Kotlin/Native API and C ABI considerations.
...
- [x] Task: Add Kotlin/Native prototype or service client and shared-fixture tests.
    - [x] Validate outputs against golden fixtures.
    - [x] Document enterprise deployment patterns.
