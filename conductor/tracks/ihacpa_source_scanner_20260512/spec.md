...
- Add `nwau sources scan` to discover relevant IHACPA source pages and downloadable artifacts.
- Add `nwau sources add-year <year>` to create or update a pricing-year manifest from discovered sources.
