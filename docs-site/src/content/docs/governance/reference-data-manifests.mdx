...
[Conductor spec](https://github.com/edithatogo/microcosting_healthservices/blob/master/conductor/tracks/reference_data_manifest_schema_20260512/spec.md)
and [CI notes](https://github.com/edithatogo/microcosting_healthservices/blob/master/conductor/tracks/reference_data_manifest_schema_20260512/ci_notes.md).
