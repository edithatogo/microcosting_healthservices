...
| --- | --- | --- |
| 2021-22 | Shadow-pricing inventory | Community MH SAS templates, calculators, and community price weights are inventoried; no official golden fixture is checked in. |
| 2022-23 | Shadow-pricing inventory | AMHCC shadow workbook is inventoried; no official golden fixture is checked in. |
