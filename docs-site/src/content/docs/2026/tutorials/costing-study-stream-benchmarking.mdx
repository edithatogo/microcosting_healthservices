...
description: Disaggregate cost and price comparisons by mental health care
  stream and benchmark against NHCDC reference costs using AHPCS methodology.
sidebar:
  label: Stream Cost Benchmarking
slug: 2026/tutorials/costing-study-stream-benchmarking
---
...
Return to [Calculating Notional Funding from Activity Data](/2026/tutorials/costing-study-nwau-nep/) to review the pricing step, or [Comparing Observed Costs to Efficient Prices](/2026/tutorials/costing-study-cost-vs-price/) for the baseline cost-vs-price analysis.
