...
description: Use the shared CLI and file boundaries for shell scripts,
  notebooks, R, Julia, Power Platform, SAS-adjacent workflows, and batch
  systems.
sidebar:
  label: CLI/file interop
slug: 2026/tutorials/cli-file-interop
---
