...
description: Use the nwau_py package to transform ABF activity data into
  notional equivalent funding (NEP) estimates for mental health services.
sidebar:
  label: Notional Funding from Activity
slug: 2026/tutorials/costing-study-nwau-nep
---
...
* [Comparing Observed Costs to Efficient Prices](/2026/tutorials/costing-study-cost-vs-price/) – bring in actual cost data alongside these NEP estimates.
* [Stream-Level Cost Benchmarking](/2026/tutorials/costing-study-stream-benchmarking/) – break the comparison down by care stream and benchmark against NHCDC.
